# Organized Crime in Italy: A Regional Trend Analysis (2006–2023)
...
1. Download `Analysis_Calculations.xlsx`.
2. Review the "Calculations" tab to see how the *Relative Risk Index* was computed.
3. Compare with the raw data in `ISTAT_raw_data.xlsx`.
